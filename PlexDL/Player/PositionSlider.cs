        ...
        private void SetPositionSliderMode(bool progressMode)
        {
            ...
            if (_base._hasPositionSlider)
            {
                if (_base._psHandlesProgress)
                {
                    ...
                    _base._positionSlider.Maximum = _base._stopTime == 0
                    ? (_base._mediaLength == 0 ? 10 : (int)(_base._mediaLength * Player.TICKS_TO_MS))
                    : (int)(_base._stopTime * Player.TICKS_TO_MS);
