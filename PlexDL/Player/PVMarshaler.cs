...
namespace PlexDL.Player
{
    internal sealed class PVMarshaler : ICustomMarshaler
    {
        private class MyProps
        {
            ...
            [ThreadStatic] private static MyProps[] m_CurrentProps;
            ...
            {
                var ip = Marshal.AllocCoTaskMem(iSize);
                m_IAllocated = true;
                return ip;
            }
        }
